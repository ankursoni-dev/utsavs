...
- [marketing-page](modules/marketing-page.md) — Marketing landing page at /: cinematic v2 page (12 sections, AmbientLayer, SectionBridge color transitions, motion primitives library, brand system); v1 preserved at /v1
