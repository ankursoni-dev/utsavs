    ...
    <div className="min-h-screen bg-bg text-text">
      <header className="sticky top-0 z-50 bg-bg/80 backdrop-blur-md border-b border-border">
        <div className="mx-auto max-w-6xl px-6 h-16 flex items-center justify-between">
          {/* Logo */}
          <a href="/" className="font-display text-2xl tracking-tight text-charcoal">
            utsavs
          </a>
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a href="#themes" className="text-sm text-text-muted hover:text-text transition-colors">
              Themes
            </a>
          </nav>
      ...
      <footer className="border-t border-border bg-bg py-12">
        <div className="mx-auto max-w-6xl px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex flex-col items-center md:items-start gap-1">
            ...
            <span className="text-text-muted text-sm">Your wedding, orchestrated.</span>
          </div>
          <p className="text-sm text-text-subtle">© 2026 Utsavs</p>
